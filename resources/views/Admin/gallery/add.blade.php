...
@section('content')
    ...
    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.galleries.insert') }}">
        @csrf
            ...
            @foreach (App\Models\Admin\Language::all() as $item)
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td><input id="title" type="text" name="title[{{ $item->id }}]" class="form-control" value="">
                        </td>
                    </tr>
                </table>
            @endforeach
